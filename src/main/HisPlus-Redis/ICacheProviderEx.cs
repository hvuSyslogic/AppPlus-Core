...
namespace HisPlus.Redis
{
    public static partial class ICacheProviderEx
    {
        ...
        //{
        //    cacheProvider.AddTagsToSetMember(GetHashedKey<T>(), member, tags);
        //}

        public static void AddToSet<T>(this ICacheProvider cacheProvider, T value, string[] tags = null, TimeSpan? ttl = null)
        {
            cacheProvider.AddToSet(GetHashedKey<T>(), value, tags, ttl);
        }
        ...
        {
            cacheProvider.AddToSortedSet(GetHashedKey<T>(), score, value, tags, ttl);
        }
        ...
        {
            //return cacheProvider.GetHashed<TV>(GetHashedKey<TK>(), field);
        ...
        //bool RemoveFromSortedSet<T>(string key, T value) { throw new NotImplementedException(); }
        ...
        {
            cacheProvider.SetHashed(GetHashedKey<T>(), fieldValues);
        }
        ...
        {
            cacheProvider.SetHashed(GetHashedKey<T>(), GetHashedField<T>(key), value, ttl, when);
        }
        ...
        {
            cacheProvider.SetHashed(GetHashedKey<T>(), GetHashedField<T>(key), value, tags, ttl, when);
        }
        ...
        {
            cacheProvider.SetObject(GetHashedKey<T>(), value, ttl, when);
        }
        ...
        {
            cacheProvider.SetObject(GetHashedKey<T>(), value, tags, ttl, when);
        }

        public static bool TryGetHashed<T>(this ICacheProvider cacheProvider, object key, out T value)
        {
            return cacheProvider.TryGetHashed(GetHashedKey<T>(), GetHashedField<T>(key), out value);
        }

        public static bool TryGetObject<T>(this ICacheProvider cacheProvider, object key, out T value)
        {
            return cacheProvider.TryGetObject(GetObjectKey<T>(key), out value);
        }
