namespace Xy.Pis.Domain
{
    ...
    // BsItem
    public partial class BsItemMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<BsItem>
    {
        public BsItemMap()
            : this("dbo")
        {
        ...
        public BsItemMap(string schema)
        {
            ...
            // Foreign keys
            HasOptional(a => a.BsLocation).WithMany(b => b.BsItems).HasForeignKey(c => c.LocationId).WillCascadeOnDelete(false); // FK_BsItem_BsLocation
            InitializePartial();
        }
