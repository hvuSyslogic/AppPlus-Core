namespace Xy.Pis.Domain
{
    ...
    // BsLocation
    public partial class BsLocationMap : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<BsLocation>
    {
        ...
        public BsLocationMap(string schema)
        {
            ...
            Property(x => x.AppLevel).HasColumnName(@"AppLevel").IsOptional().HasColumnType("smallint");
