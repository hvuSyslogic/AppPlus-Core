...
namespace HisPlus.Domain.Mapping
{
    public class DgRoadDtlMap : EntityTypeConfiguration<DgRoadDtl>
    {
        ...
        public DgRoadDtlMap(string schema)
        {
            ToTable("DgRoadDtl", schema);
            HasKey(x => x.Id);
            ...
            Property(x => x.IsNeed).HasColumnName(@"IsNeed").IsOptional().HasColumnType("bit");
            Property(x => x.IsReason).HasColumnName(@"IsReason").IsOptional().HasColumnType("bit");
