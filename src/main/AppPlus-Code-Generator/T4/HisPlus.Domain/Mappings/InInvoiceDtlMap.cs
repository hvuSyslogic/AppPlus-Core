...
namespace HisPlus.Domain.Mapping
{
    public class InInvoiceDtlMap : EntityTypeConfiguration<InInvoiceDtl>
    {
        ...
        public InInvoiceDtlMap(string schema)
        {
            ...
            Property(x => x.AmountSelf).HasColumnName(@"AmountSelf").IsRequired().HasColumnType("decimal").HasPrecision(18,4);
            Property(x => x.AmountTally).HasColumnName(@"AmountTally").IsRequired().HasColumnType("decimal").HasPrecision(18,4);
