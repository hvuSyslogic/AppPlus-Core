...
namespace HisPlus.Domain.Mapping
{
    public class BsAreaRegionMap : EntityTypeConfiguration<BsAreaRegion>
    {
        ...
        public BsAreaRegionMap(string schema)
        {
            ToTable("BsAreaRegion", schema);
            HasKey(x => x.Id);
            ...
            Property(x => x.ProvId).HasColumnName(@"ProvId").IsRequired().HasColumnType("int");
            Property(x => x.AreaCode).HasColumnName(@"AreaCode").IsOptional().HasColumnType("nvarchar").HasMaxLength(10);
