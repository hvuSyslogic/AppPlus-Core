...
namespace HisPlus.Domain.Mapping
{
    public class BsRoomMap : EntityTypeConfiguration<BsRoom>
    {
        ...
        public BsRoomMap(string schema)
        {
            ToTable("BsRoom", schema);
            HasKey(x => x.Id);
            ...
            Property(x => x.LsRoomType).HasColumnName(@"LsRoomType").IsRequired().HasColumnType("smallint");
            ...
            Property(x => x.IsRoom).HasColumnName(@"IsRoom").IsOptional().HasColumnType("bit");
        }
    }
}
