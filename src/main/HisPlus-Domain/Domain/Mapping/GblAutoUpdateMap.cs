...
namespace HisPlus.Domain.Mapping
{
    public class GblAutoUpdateMap : EntityTypeConfiguration<GblAutoUpdate>
    {
        ...
        public GblAutoUpdateMap(string schema)
        {
            ToTable("GblAutoUpdate", schema);
            HasKey(x => x.Id);
            ...
            Property(x => x.FileSize).HasColumnName(@"FileSize").IsOptional().HasColumnType("nvarchar").HasMaxLength(10);
        }
    }
}
