namespace HisPlus.Domain.Mapping
{
    ...
    public class BsDoctorBackMap : EntityTypeConfiguration<BsDoctorBack>
    {
        ...
        public BsDoctorBackMap(string schema)
        {
            ToTable("BsDoctorBack", schema);
            HasKey(x => new { x.Id, x.Code, x.Name, x.Sex, x.Address, x.City, x.Mobile, x.Email, x.Introduce, x.LocationId, x.PicturePath, x.LsStatus, x.OrderBy, x.IconIndex });
