...
namespace AppPlus.Core
{
    public class GlobalExceptionHandlerBehaviourAttribute : Attribute, IServiceBehavior
    {
        ...
        public void ApplyDispatchBehavior(ServiceDescription description, ServiceHostBase serviceHostBase)
        {
            ...
            {
                throw new ArgumentException("The errorHandlerType specified in the GlobalExceptionHandlerBehaviourAttribute constructor must have a public empty constructor.", mme);
            }
