    ...
    public class CacheProvider : ICacheProvider
    {
        ...
        public bool StringSet(List<KeyValuePair<RedisKey, RedisValue>> keyValues)
        {
            List<KeyValuePair<RedisKey, RedisValue>> newkeyValues =
                keyValues.Select(p => new KeyValuePair<RedisKey, RedisValue>(CustomizedKey(p.Key), p.Value)).ToList();
        ...
        {
            List<string> newKeys = listKey.Select(CustomizedKey).ToList();
        ...
        {
            List<string> newKeys = keys.Select(CustomizedKey).ToList();
